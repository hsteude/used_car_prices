...
def create_links():
    ...
    for k in range(1, 21):
        links.append([
            'https://www.autoscout24.de/lst/porsche/911er-(alle)?sort=standard&desc=0&ustate=N%2CU&size=20&page='+str(
                k)+'&atype=C&'
            'https://www.autoscout24.de/lst/porsche/911er-(alle)?sort=price&desc=0&ustate=N%2CU&size=20&page='+str(
                k)+'&atype=C&',
            'https://www.autoscout24.de/lst/porsche/911er-(alle)?sort=price&desc=1&ustate=N%2CU&size=20&page='+str(
                k)+'&atype=C&',
            'https://www.autoscout24.de/lst/porsche/911er-(alle)?sort=financerate&desc=0&ustate=N%2CU&size=20&page='+str(
                k)+'&atype=C&',
            'https://www.autoscout24.de/lst/porsche/911er-(alle)?sort=financerate&desc=1&ustate=N%2CU&size=20&page='+str(
                k)+'&atype=C&',
            'https://www.autoscout24.de/lst/porsche/911er-(alle)?sort=age&desc=1&ustate=N%2CU&size=20&page='+str(
                k)+'&atype=C&',
            'https://www.autoscout24.de/lst/porsche/911er-(alle)?sort=mileage&desc=0&ustate=N%2CU&size=20&page='+str(
                k)+'&atype=C&',
            'https://www.autoscout24.de/lst/porsche/911er-(alle)?sort=mileage&desc=1&ustate=N%2CU&size=20&page='+str(
                k)+'&atype=C&',
            'https://www.autoscout24.de/lst/porsche/911er-(alle)?sort=power&desc=0&ustate=N%2CU&size=20&page='+str(
                k)+'&atype=C&',
            'https://www.autoscout24.de/lst/porsche/911er-(alle)?sort=power&desc=1&ustate=N%2CU&size=20&page='+str(
                k)+'&atype=C&',
            'https://www.autoscout24.de/lst/porsche/911er-(alle)?sort=year&desc=0&ustate=N%2CU&size=20&page='+str(
                k)+'&atype=C&',
            'https://www.autoscout24.de/lst/porsche/911er-(alle)?sort=year&desc=1&ustate=N%2CU&size=20&page='+str(
                k)+'&atype=C&'
        ])
...
def car_table_from_summary_page(quote_page):
    ...
    for offering in offerings:
        ...
        headline.append(offering.find(
            'div', {'data-item-name': 'headline'}).text)
        price.append(offering.find('span', {'data-item-name': 'price'}).text)
        details.append(offering.find(
            'ul', {'data-item-name': 'vehicle-details'}).text)
...
def read_detail_pages(detail_link):
    ...
    soup = BeautifulSoup(response.content, "html.parser")
    state_str = soup.find(
        "div", {'class': "cldt-categorized-data cldt-data-section sc-pull-left"}).text
    features_str = soup.find(
        "div", {'class': "cldt-categorized-data cldt-data-section sc-pull-right"}).text
...
def scrape_detail_pages(df_cars):
    ...
    for i in range(0, len(df_cars)):
        try:
            time.sleep(1)
            state_str_i, features_str_i = read_detail_pages(
                df_cars.detail_link[i])
